...
interface FormApplicantMarriageProps extends FormBaseProps {
  codeFamilyStatus: number | undefined,
  buttons?: ReactNode,
}


const FormApplicantMarriage = (props: FormApplicantMarriageProps) => {
...
export default FormApplicantMarriage;